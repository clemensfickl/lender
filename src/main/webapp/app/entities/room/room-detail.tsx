  ...
  render() {
    ...
    return (
      <Row>
        <Col md="8">
          <h2>
            <Translate contentKey="lenderApp.room.detail.title">Room</Translate> [<b>{roomEntity.id}</b>]
          </h2>
          <dl className="jh-entity-details">
            <dt>
              <span id="name">
                <Translate contentKey="lenderApp.room.name">Name</Translate>
              </span>
            </dt>
            <dd>{roomEntity.name}</dd>
            <dt>
              <span id="description">
                <Translate contentKey="lenderApp.room.description">Description</Translate>
              </span>
            </dt>
